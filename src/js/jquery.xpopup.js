(function ($) {
     ...
     *
     * ОБНОВЛЕНИЕ: заменены устаревшие методы $.each, $.type и т.д. на нативные аналоги
     */
    const xpopupApi = ($.xpopup = new (class XpopupApi {
         ...
         */
        constructor() {
            this.DEBUG = false; // установить true для отладки
            ...
            this.EVENT_WINDOW_RENDER_CONTENT_BEFORE = 'xpopup_window_render_content_before'; //Перед тем как размре бокса будут изменен
            ...
            this.defaults = {
                ...
                // maxSize: null, // null, '', 'screen', Если 'screen', то размеры окна не могут быть больше размеров экрана (viewport). Это значение также будет установлено автоматически, если maxHeight==='100%' и maxWidth==='100%'. Добавляет в box класс b-xpopup_fullscreen_true
