...
uglifyjs --compress --mangle --output dist/js/jquery.xpopup.min.js -- src/js/xpopup_utils.js src/js/xpopup_storage.js src/js/jquery.xpopup.js src/js/xpopup_window_ctrl.js src/js/xpopup_types.js src/js/xpopup_autorun.js
